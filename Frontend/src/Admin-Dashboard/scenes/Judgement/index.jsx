import {
  ...
  const JudgementHearing = () => {
    ...
    const handleUpload = async (e) => {
      ...
      await fetch("http://localhost:3000/judgement/add", {
        method: "POST",
        body: formData,
      });
    ...
    const handleDelete = async (id) => {
      await axios.delete(`http://localhost:3000/judgement/${id}`);
    ...
    return (
      <>
        <Box m="20px">
          <Header title="Manage Judgement Hearing" subtitle="List" />
          <Box
            mt="40px"
            height="75vh"
            maxWidth="100%"
  ...
  export default JudgementHearing;
