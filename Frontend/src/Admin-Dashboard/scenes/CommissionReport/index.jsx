import {
  ...
  const CommissionReport = () => {
    ...
    const handleUpload = async (e) => {
      ...
      await fetch("http://localhost:3000/commission/add", {
        method: "POST",
        body: formData,
      });
    ...
    const handleDelete = async (id) => {
      await axios.delete(`http://localhost:3000/commission/${id}`);
    ...
    return (
      <>
        <Box m="20px">
          <Header title="Commissions Report" subtitle="List of Reports" />
          <Box
            mt="40px"
            height="75vh"
            maxWidth="100%"
