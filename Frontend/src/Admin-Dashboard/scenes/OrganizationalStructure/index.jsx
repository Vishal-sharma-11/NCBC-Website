...
const OrganizationalStructure = () => {
  ...
  const handleUpload = async (e) => {
    ...
    await fetch("http://localhost:3000/organizational/add", {
      method: "POST",
      body: formData,
    });
  ...
  const handleDelete = async (id) => {
    await axios.delete(`http://localhost:3000/organizational/${id}`);
  ...
  return (
    <>
      <Box m="20px">
        <Header title="Manage Organizational Structure" subtitle="List" />
        <Box
          mt="40px"
          height="75vh"
          maxWidth="100%"
